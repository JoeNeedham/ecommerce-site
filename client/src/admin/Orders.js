...
const Orders = () => {
    ...
    return (
        <Layout
            title='Orders'
            description="you can manage all the orders here"
        >
            <div className="row">
                <div className="col-md-8 offset-md-2">
                    ...
                    {orders.map((o, oIndex) => {
                        return(
                            <div classname="mt-5" key={oIndex} sytle={{borderBottom: '5px solid indigo'}}>
                                <h2 className="mb-5">
                                ...
                                <ul className="list-group mb-2">
                                    ...
                                    <li className="list-group-item">{o.user.name}</li>
                                    <li className="list-group-item">{moment(o.createdAt).fromNow()}</li>
